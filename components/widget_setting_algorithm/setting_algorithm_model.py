...
class SettingAlgorithmModel:
    ...
    def __init__(self):
        ...
        # 实例设置项子类
        self.setting_asic_algorithm = SettingBasicAlgorithm(self.config)
        self.setting_is_enhance_algorithm = SettingIsEnhanceAlgorithm(self.config)
        self.setting_enhance_algorithm = SettingEnhanceAlgorithm(self.config)
        self.setting_similar_threshold = SettingSimilarThreshold(self.config)
        self.setting_hash_length = SettingHashLength(self.config)
