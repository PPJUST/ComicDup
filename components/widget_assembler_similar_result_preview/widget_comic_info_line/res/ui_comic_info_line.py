...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.label_special_indicators, 4, 1, 1, 1)

        self.label_translator = QLabel(Form)
        self.label_translator.setObjectName(u"label_translator")

        self.gridLayout.addWidget(self.label_translator, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_language, 2, 1, 1, 1)
